...
export default function ExerciseEditor() {
  const { editMode, setEditMode, updateExercise, selectedExercise } =
    useExerciseList();
  ...
  return (
    <div className="flex flex-col">
      <form className="flex flex-col col-start-2 row-start-1 gap-4 items-end w-full">
        <div className="flex flex-row-reverse gap-4 items-center">
          <input
            type="text"
            name="title"
            value={exercise.title}
            className="px-6 w-72 h-16 rounded-lg rounded-input peer"
